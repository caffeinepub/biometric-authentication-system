...
export class Backend implements backendInterface {
    ...
    async getLoginHistory(arg0: Principal): Promise<Array<LoginEvent>> {
        if (this.processError) {
            try {
    ...
    async recordLoginEvent(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordLoginEvent(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
